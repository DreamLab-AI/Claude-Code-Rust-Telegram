...
pub(super) struct DaemonState {
    ...
    /// Optional LLM-backed summarizer for enhanced tool descriptions.
    pub(super) llm_summarizer: Arc<LlmSummarizer>,
}
...
impl Daemon {
    pub fn new(config: Config) -> Result<Self> {
        ...
        let llm_summarizer = Arc::new(LlmSummarizer::new(
            config.llm_summarize_url.clone(),
...
struct HandlerContext {
    ...
    /// Optional LLM-backed summarizer for enhanced tool descriptions.
    llm_summarizer: Arc<LlmSummarizer>,
}
